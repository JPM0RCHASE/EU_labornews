...
KEYWORDS = [
    ...
    "노동부 고용노동부","최저임금 임금","부당해고 노동위원회",
    "건설경기 건자재","건설업 노무","시멘트 레미콘 건자재",
    "HR 인사관리","교육 리더십 조직문화","고용보험 실업급여",
]
...
【선별 기준 - 중요도 순】
1. 인사·노무·임금·산재·노동부·노동청 관련 핵심 이슈
2. HR 인사관리·교육·리더십 관련 트렌드
3. 건설경기·건자재·시멘트·레미콘 관련 뉴스 (유진기업 핵심 업무 — 반드시 1건 포함 시도)
※ 5인 미만 사업장 관련 내용은 제외

【작성 기준】
- 텔레그램용이므로 핵심만 간결하게 불릿 3개
- 실무 시사점은 1~2문장으로 짧고 임팩트 있게
- 건설/건자재 뉴스가 없으면 HR·인사 뉴스로 대체
...
is_construction: 건설/건자재 관련 뉴스이면 true
총 5건"""
...
<section class="hero">
  ...
  <p class="hero-sub">꼭 알아야 할 핵심 노동법·노사·건설 이슈 5건</p>
