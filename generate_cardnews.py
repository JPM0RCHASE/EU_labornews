...
【카드 5장 주제 선별 기준】
아래 5개 영역에서 각 1건씩 선별. 오늘 뉴스에서 가장 임팩트 있는 기사를 골라 다양성을 확보하세요.

1번 — 노동법·노사관계 (택 1)
  · 노란봉투법·노조법 개정·원청 사용자성·단체교섭·파업·쟁의 중 오늘 가장 중요한 것
  · 해당 뉴스 없으면 → 해고·징계·부당노동행위 판결 중 선택

2번 — 임금·근로시간·고용조건 (택 1)
  · 최저임금·통상임금·연장근로·포괄임금·임금체불·성과급·주52시간 중 오늘의 핵심
  · 해당 뉴스 없으면 → 대기업 노사 임금교섭·파업 중 선택

3번 — 산재·안전·해고·판결 (택 1)
  · 중대재해처벌법·산업재해·부당해고·정리해고·노동위원회 판정·법원 노동 판결 중 선택
  · 가장 파급력 있는 판결·사고 우선

4번 — 정책·입법·행정 (택 1)
  · 고용노동부 정책·지침·단속·행정해석, 국회 노동법 개정안, 정부 고용정책 중 선택
  · 해당 뉴스 없으면 → 고용보험·4대보험 제도 변화로 대체

5번 — 특수·다양 이슈 (택 1)
  · 플랫폼·특수고용·비정규직·외국인 근로자·직장내 괴롭힘·정년·청년·육아휴직·
    HR 트렌드·조직문화·원격근무·인사평가 중 오늘 가장 새로운 것

※ 각 카드는 서로 다른 주제·기사를 사용할 것 (중복 금지)
※ 돌봄·요양·복지서비스·음식점·소매업·농업 뉴스는 절대 포함하지 말 것
※ 5인 미만 사업장만을 다루는 뉴스는 제외 (뉴스레터에서 별도 다룸)
