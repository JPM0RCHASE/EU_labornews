...
6. 【JP's Weekly Insight — 이번 주 지정 주제】
   이번 주 Insight 주제: 【{_insight_topic}】
   - 위 주제 범위 안에서 HR담당자·소규모 사업주가 실제로 많이 묻는 실무 질문 1개를 만들 것
   - section1_top3 및 section2_gov_policy에서 다룬 뉴스·주제와 겹치지 않는 독립적 질문이어야 함
   - 노란봉투법·원청교섭 관련 질문은 section1에서 이미 다루므로 section3에서 반복 절대 금지
   - 질문은 구체적이고 실무적으로 (예: "연차를 다 못 쓰면 수당으로 줘야 하나요?" 수준)
